...
public class IncentivosEventosPublisher implements INotificacionesClient {
    ...
    public void notificarMisionCumplida(UUID idPersona, String nombreMision, String recompensa) {
        publicar(
                ...
                new EventoIncentivoMisionCumplidaV1(idPersona, LocalDateTime.now(ZoneId.systemDefault()), nombreMision, recompensa),
                idPersona);
    }
    ...
    public void notificarAscensoCategoria(
        ...
        publicar(
                ...
                new EventoIncentivoSubioCategoriaV1(idPersona, LocalDateTime.now(ZoneId.systemDefault()), categoriaNueva, categoriaVieja),
                idPersona);
    }
    ...
    public void notificarInactividad(UUID idPersona, int diasInactivo) {
        publicar(
                ...
                new EventoIncentivoDonanteInactivoV1(idPersona, LocalDateTime.now(ZoneId.systemDefault()), diasInactivo),
                idPersona);
    }
