...
|:---:|---|---|---|---|---|---|---|
| 1 | Donación Asignada (Enriquecido) | `donaciones-service` | `donaciones.exchange` | `donacion.asignada.v1` | `donacion.asignada.v1` | `notificaciones.donaciones`, `logistica.donaciones.asignadas`, `incentivos.donaciones` | [`evento-donacion-asignada-v1.schema.json`](../../arquitectura/contratos/schemas/evento-donacion-asignada-v1.schema.json) |
...
| 7 | Persona Sincronizada | `donaciones-service` | `donaciones.exchange` | `persona.sincronizada.v1` | `persona.sincronizada.v1` | `notificaciones.donaciones`, `incentivos.personas` | [`evento-persona-sincronizada-v1.schema.json`](../../arquitectura/contratos/schemas/evento-persona-sincronizada-v1.schema.json) |
