...
Justificación:
Por ahora utilizaremos esta alternativa debido a la baja complejidad en la implementación, pero se deberá analizar nuevamente la decisión para la Entrega 2.
