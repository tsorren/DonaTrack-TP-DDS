...
Debido a que las notificaciones tienen mensajes distintos pero siguen cierta estructura, debemos modelar una solución
que permita la creación polimórfica de estas notificaciones.
...
La asignación de una donación a una entidad beneficiaria y la recepción de una donación (se notifica al donante y a la
entidad beneficiaria en ambos casos)
...
Justificación:
Permite gestionar las notificaciones con mayor facilidad, evita errores de la lógica de negocio al asociar los mensajes
con los destinatarios. La clase abstracta EventoNotificable es extendida por las clases DonanteRegistrado,
MisionCumplida, SubioCategoria, y la clase abstracta EventoDeDonacion(Ver decisión de diseño asociada).
