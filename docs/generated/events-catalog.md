...
| [`evento-donacion-asignada-v1.schema.json`](../arquitectura/contratos/schemas/evento-donacion-asignada-v1.schema.json) | `EventoDonacionAsignadaV1` | `object` | `donacionIndependienteId`, `personaDonanteId`, `fecha`, `personaBeneficiariaId`, `descripcion`, `destino`, `pesoTotalKG`, `volumenTotalM3`, `categorias`, `cantidades` |
| [`evento-donacion-en-camino-v1.schema.json`](../arquitectura/contratos/schemas/evento-donacion-en-camino-v1.schema.json) | `EventoDonacionEnCaminoV1` | `object` | `personaDonanteId`, `fecha`, `personaBeneficiariaId`, `descripcion`, `urlMapa` |
| [`evento-donacion-entrega-fallida-v1.schema.json`](../arquitectura/contratos/schemas/evento-donacion-entrega-fallida-v1.schema.json) | `EventoDonacionEntregaFallidaV1` | `object` | `personaDonanteId`, `fecha`, `personaBeneficiariaId`, `descripcion`, `personaAdminId`, `justificacion`, `replanificable` |
| [`evento-donacion-recibida-v1.schema.json`](../arquitectura/contratos/schemas/evento-donacion-recibida-v1.schema.json) | `EventoDonacionRecibidaV1` | `object` | `personaDonanteId`, `fecha`, `personaBeneficiariaId`, `descripcion`, `patenteCamion` |
| [`evento-donacion-vencida-v1.schema.json`](../arquitectura/contratos/schemas/evento-donacion-vencida-v1.schema.json) | `EventoDonacionVencidaV1` | `object` | `personaDonanteId`, `fecha`, `personaAdminId`, `descripcion`, `motivo` |
| [`evento-donante-registrado-v1.schema.json`](../arquitectura/contratos/schemas/evento-donante-registrado-v1.schema.json) | `EventoDonanteRegistradoV1` | `object` | `personaDonanteId`, `fecha`, `credencialesDeAcceso` |
...
| [`evento-incentivo-donante-inactivo-v1.schema.json`](../arquitectura/contratos/schemas/evento-incentivo-donante-inactivo-v1.schema.json) | `EventoIncentivoDonanteInactivoV1` | `object` | `personaDonanteId`, `fecha`, `diasInactividad` |
| [`evento-incentivo-mision-cumplida-v1.schema.json`](../arquitectura/contratos/schemas/evento-incentivo-mision-cumplida-v1.schema.json) | `EventoIncentivoMisionCumplidaV1` | `object` | `personaDonanteId`, `fecha`, `nombreMision`, `puntosObtenidos` |
| [`evento-incentivo-subio-categoria-v1.schema.json`](../arquitectura/contratos/schemas/evento-incentivo-subio-categoria-v1.schema.json) | `EventoIncentivoSubioCategoriaV1` | `object` | `personaDonanteId`, `fecha`, `nombreNuevaCategoria` |
...
| [`evento-persona-sincronizada-v1.schema.json`](../arquitectura/contratos/schemas/evento-persona-sincronizada-v1.schema.json) | `EventoPersonaSincronizadaV1` | `object` | `personaId`, `denominacion`, `tipoPersona` |
