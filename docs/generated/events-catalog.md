...
| [`evento-donacion-asignada-v1.schema.json`](../arquitectura/contratos/schemas/evento-donacion-asignada-v1.schema.json) | `EventoDonacionAsignadaV1` | `object` | `personaDonanteId`, `fecha`, `personaBeneficiariaId`, `descripcion` |
