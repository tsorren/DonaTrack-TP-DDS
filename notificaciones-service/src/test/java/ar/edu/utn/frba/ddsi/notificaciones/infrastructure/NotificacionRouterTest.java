...
import ar.edu.utn.frba.ddsi.notificaciones.models.entities.medioDeContacto.Correo;
import ar.edu.utn.frba.ddsi.notificaciones.models.entities.medioDeContacto.Telefono;
import ar.edu.utn.frba.ddsi.notificaciones.models.entities.medioDeContacto.WhatsApp;
import ar.edu.utn.frba.ddsi.notificaciones.models.entities.notificaciones.EstadoNotificacion;
...
class NotificacionRouterTest {
    ...
    @Test
    void notificar_cuandoCorreoAgregadoUltimoYEsPredeterminado_deberiaUsarseAntesTelefonoAgregadoPrimero() {
        persona.agregarMedioDeContacto(telefono);
        persona.agregarMedioDeContacto(correo);
        when(correoApi.enviarMail(eq("donante@test.com"), anyString())).thenReturn(true);
