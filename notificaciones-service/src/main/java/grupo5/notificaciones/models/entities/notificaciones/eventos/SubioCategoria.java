...
public class SubioCategoria extends EventoNotificable {
  ...
  private String categoriaNueva;
    ...
    public SubioCategoria(Persona persona, String categoriaVieja, String categoriaNueva, LocalDateTime fecha) {
        super();
  ...
  public List<Notificacion> generarNotificaciones() {
    Notificacion notificacion =
        new Notificacion(this.getPersona(), "Subiste a la categoría " + categoriaNueva + "desde la categoria" + categoriaVieja);
