...
class AlgoritmoPrioridadSubAtendidosTest {
  ...
  void setUp() {
    ...
    donacionEnOtraSubcategoria = new DonacionIndependiente(donacionOriginal, subcategoriaOtra, itemsOtros);
  ...
  void filtrarDonaciones_cuandoMismaSubcategoria_debeIncluirla() {
    NecesidadExtraordinaria necesidad = new NecesidadExtraordinaria(subcategoria, 3, "necesito ropa de invierno");
  ...
  void ordenarNecesidades_cuandoUnaEntidadTieneMayorPorcentajeSatisfecho_debeQuedarAlFinal() {
    ...
    NecesidadExtraordinaria necesidadHistoricaSatisfecha = new NecesidadExtraordinaria(subcategoria, 5, "necesidad historica satisfecha");
    necesidadHistoricaSatisfecha.setEntidad(entidadMuyAtendida);
    necesidadHistoricaSatisfecha.asignarDonacion(donacionEnSubcategoria); // 5 unidades, queda satisfecha
    ...
    NecesidadExtraordinaria necesidadHistoricaInsatisfecha = new NecesidadExtraordinaria(subcategoria, 5, "necesidad historica insatisfecha");
    ...
    NecesidadExtraordinaria necesidadActualMuyAtendida = new NecesidadExtraordinaria(subcategoria, 10, "nueva necesidad de entidad muy atendida");
    necesidadActualMuyAtendida.setEntidad(entidadMuyAtendida);

    NecesidadExtraordinaria necesidadActualPocoAtendida = new NecesidadExtraordinaria(subcategoria, 5, "nueva necesidad de entidad poco atendida");
    ...
    List<grupo5.donaciones.models.entities.necesidades.Necesidad> resultado = algoritmo.ordenarNecesidades(necesidades);
  ...
  void ordenarNecesidades_cuandoNingunaTieneEntidad_debeRetornarLasMismas() {
    NecesidadExtraordinaria necesidad1 = new NecesidadExtraordinaria(subcategoria, 5, "primera necesidad sin entidad");
    NecesidadExtraordinaria necesidad2 = new NecesidadExtraordinaria(subcategoria, 5, "segunda necesidad sin entidad");
  ...
  void filtrarDonaciones_conNecesidadNula_debeLanzarExcepcion() {
    ...
    ValidationException exception = assertThrows(
        ...
        () -> algoritmo.filtrarDonaciones(null, donaciones));
  ...
  void filtrarDonaciones_conListaNula_debeLanzarExcepcion() {
    ...
    ValidationException exception = assertThrows(
        ValidationException.class,
        () -> algoritmo.filtrarDonaciones(necesidad, null));
  ...
  void ordenarNecesidades_conListaNula_debeLanzarExcepcion() {
    ValidationException exception = assertThrows(
        ValidationException.class,
        () -> algoritmo.ordenarNecesidades(null));
