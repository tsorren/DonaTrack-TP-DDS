...
class PersonasRepositoryTest {
  ...
  void findById_deberiaRetornarPersonaSiExiste() {
    Humana humana = new Humana("Pedro", "Gimenez", LocalDate.of(1985, Month.AUGUST, 20));
  ...
  void delete_deberiaRemoverPersona() {
    Humana humana = new Humana("Jose", "Sanz", LocalDate.of(1975, Month.DECEMBER, 1));
    repository.save(humana);
  ...
  void findAll_deberiaRetornarTodasLasPersonas() {
    Humana p1 = new Humana("A", "B", LocalDate.of(1990, Month.JANUARY, 1));
    Humana p2 = new Humana("C", "D", LocalDate.of(1991, Month.JANUARY, 1));
